...
想部署同款网站？联系微信：532234600

[演示 Demo](https://cs.anmody.com/) / [反馈 Issues](https://github.com/bg7iae/CGC-ChatGPT/issues)
...
2. 点击右侧按钮开始部署：记得在环境变量页填入 API Key 和[页面访问密码](#配置页面访问密码) CODE；
3. 部署完毕后，即可开始使用；
4. （可选）[绑定自定义域名]。
...
> **警告**：请务必将密码的位数设置得足够长，最好 7 位以上，否则[会被爆破](https://cs.anmody.com)。
